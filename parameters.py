...
MongDuong1.base_coal_consumption = 2.75 * ureg.megaton / ureg.year
...
MongDuong1.coal_price = 52.69 * ureg.USD / ureg.ton
...
MongDuong1.biomass_required = 259107.274137779 * ureg.ton / ureg.year
MongDuong1.biomass_unit_cost = 41.311153541657 * ureg.USD / ureg.ton
...
MongDuong1.coal_saved = 155986.88053583 * ureg.ton / ureg.year
...
MongDuong1.ef_coal_transport = 0 * ureg.kilogram / ureg.ton / ureg.kilometer
MongDuong1.ef_biomass_combust = 0.0858 * ureg.kilogram / ureg.megajoule
MongDuong1.ef_biomass_transport = 0.062 * ureg.kilogram / ureg.ton / ureg.kilometer
...
NinhBinh.base_coal_consumption = 0.42 * ureg.megaton / ureg.year
...
NinhBinh.coal_price = 83.83 * ureg.USD / ureg.ton
NinhBinh.fix_om_cost = 32.24 * ureg.USD / ureg.kilowatthour * ureg.year
NinhBinh.variable_om_cost = 0.006 * ureg.USD / ureg.kilowatthour
# Computed separately. Assumes 5% co-firing
NinhBinh.biomass_required = 53362.0062849769 * ureg.ton / ureg.year
NinhBinh.biomass_unit_cost = 38.154337591058 * ureg.USD / ureg.ton
...
NinhBinh.coal_saved = 24664.423049406 * ureg.ton / ureg.year
...
NinhBinh.ef_coal_transport = 0.031 * ureg.kilogram / ureg.ton / ureg.kilometer
NinhBinh.ef_biomass_combust = 0.0858 * ureg.kilogram / ureg.megajoule
NinhBinh.ef_biomass_transport = 0.062 * ureg.kilogram / ureg.ton / ureg.kilometer
