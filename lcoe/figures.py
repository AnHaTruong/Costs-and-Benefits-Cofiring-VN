...
def plot_lcoe_figure(index, ff_scenarios, re_scenarios, color, text):
    ...
    plt.legend(
        loc="upper left",
        handles=[legend_capital, legend_OM, legend_fuel],
        prop={"size": 9},
    )
...
plt.title(
    "Cost of electricity from different technologies (VN technology catalogue 2019)"
)
plt.savefig("LCOE-4tech-3years-catalogue.png")
plt.clf()

plot_lcoe_figure(
    index2, ["2020", "2030", "2050"], ["2020", "2030", "2050"], color2, [" ", " ", " "]
)
...
plot_lcoe_figure(
    index1,
    ["2020", "Lower20", "Upper20"],
    ["2020", "Upper20", "Lower20"],
    color1,
...
plot_lcoe_figure(
    index1,
    ["2050", "Lower50", "Upper50"],
    ["2020", "Upper50", "Lower50"],
    color1,
    ["Base", "maxFF, minRE", "minFF, maxRE"],
)
...
lcoe_coal_SC = create_LCOE_df(
    Coal_Supercritical, "coal_IEA", "coal_IEA_upper", "coal_IEA_lower"
)
