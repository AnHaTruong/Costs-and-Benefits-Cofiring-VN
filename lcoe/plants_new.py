...
def create_plant_new(name, tech_data, fuel, year, fuel_price):
...
def create_plant_dict_new(tech_name, tech_data, fuel_list, fuel_price):
    ...
    for year in ["2020", "2030", "2050", "Lower20", "Upper20", "Lower50", "Upper50"]:
        ...
        for fuel in fuel_list:
            arg = [tech_name, tech_data, fuel, year, fuel_price]
            plant = create_plant_new(*arg)
            plant_dict[year][fuel.name] = plant
    return plant_dict


def create_RE_plant_new(name, tech_data, year, fuel_price):
...
def create_REplant_dict_new(tech_name, tech_data, fuel_price):
    """Create a dictionary of RE plants in 2020, 2030 and 2050."""
    plant_dict = dict()
    for year in ["2020", "2030", "2050", "Lower20", "Upper20", "Lower50", "Upper50"]:
        arg = [tech_name, tech_data, year, fuel_price]
