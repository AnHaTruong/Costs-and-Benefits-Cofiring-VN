...
from parameters import MongDuong1, cofire_MD1, straw, MD_SupplyChain
...
npvA = MongDuong1NullCofiring.plant.net_present_value(1 * USD / kWh, 0.08, 0.2, 10)
...
lcoeA = MongDuong1NullCofiring.plant.lcoe(1 * USD / kWh, 0.08, 0.2, 10)
