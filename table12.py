...
def print_benefit_add_up(plant):
    col1 = benefit_add_up(total_health_benefit, plant)
    col2 = benefit_add_up(emission_reduction_benefit, plant)
    col3 = benefit_add_up(total_job_benefit, plant)
    col4 = benefit_add_up(total_income_benefit, plant)
    col5 = total_benefit_addup(plant)
...
print('')
print_benefit_add_up(MongDuong1)

print('')
print('Added up benefit Ninh Binh')
print('')
print_benefit_add_up(NinhBinh)
